...
INSERT INTO `movie` (`title`, `year`, `image`) VALUES
    ('Star Wars', 1977, 'image/starwars.jpg'),
    ('Titanic', 1997, 'image/titanic.jpg'),
    ('Harry Potter and the deathly hollow part 1', 2010, 'image/harrypotter1.jpg'),
    ('Harry Potter and the deathly hollow part 2', 2011, 'image/harrypotter2.jpg'),
    ('Braveheart', 1995, 'image/braveheart.jpg'),
    ('The Avengers', 2012, 'image/avengers.jpg'),
    ('The Dark knight', 2008, 'image/darkknight.jpg')
;
SELECT * FROM `movie`;
